...
public class ViewInventoryController {
    ...
    public void fillTable() {
        try {
            ...
            for (UtilityItemDTO utilityItemDTO : utilityItemsDTO) {
                Object[] row = {utilityItemDTO.getID(), utilityItemDTO.getName(), utilityItemDTO.getQuantity(), utilityItemDTO.getPrice()};
                model.addRow(row);
            }
    ...
    class ViewInventoryRemoveItemBtnAction implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            try {
                DefaultTableModel tableModel = (DefaultTableModel) viewInventoryGUI.getjTableAdminInventoryItems().getModel();
                ...
                // Confirm deletion
                int confirm = JOptionPane.showConfirmDialog(null, "Are you sure you want to remove this item?", "Confirm Deletion", JOptionPane.YES_NO_OPTION);
