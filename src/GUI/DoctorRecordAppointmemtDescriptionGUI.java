...
public class DoctorRecordAppointmemtDescriptionGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextAreaDescriptionAppointmentDescription.setEditable(false);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorRecordAppointmemtDescriptionGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
