...
public class DoctorViewAppointmentGUI extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTableAppointmentDetailsViewAppointment.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "Date", "Price", "Animal Name", "Animal Type", "Animal Breed", "Animal Age", "Description"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorViewAppointmentGUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
